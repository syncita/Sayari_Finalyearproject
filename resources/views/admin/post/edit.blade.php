                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select id="status" class="form-control" name="status">
                                        <option value="pending" {{ 'pending' == $post->status ? 'selected' : '' }}>
                                            Pending</option>
                                        <option value="approved" {{ 'approved' == $post->status ? 'selected' : '' }}>
                                            Approved</option>
                                        <option value="rejected" {{ 'rejected' == $post->status ? 'selected' : '' }}>
                                            Rejected</option>
                                    </select>
                                </div>
                            </div>
